...
<div class="form-structor">
  <div class="signup">
    ...
    <div class="form-holder">
      ...
      <input type="text" class="input" name="phone" placeholder="핸드폰 번호 -를 뺴고 입력해주세요">
      <input type="text" class="input" name="birth" placeholder="생년월일 8자리">
      <input type="text" class="input" id="address" name="address" readonly placeholder="주소"/>
      <input type="text" class="input" name="addressDetail" placeholder="상세주소"/>
    </div>
