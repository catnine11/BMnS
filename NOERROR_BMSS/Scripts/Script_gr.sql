...
SELECT * FROM BOOK_STATUS WHERE BOOK_SEQ =60 ;


SELECT BORROW_TITLE ,STATUS_CODE ,BB.BOOK_SEQ FROM BOOK_BORROW bb LEFT JOIN BOOK_STATUS bs  ON BB.BOOK_SEQ =BS .BOOK_SEQ  WHERE STATUS_CODE='B';

SELECT BORROW_TITLE ,STATUS_CODE, bs.BOOK_SEQ 
FROM BOOK_BORROW bb LEFT JOIN BOOK_STATUS bs  
ON BB.BOOK_SEQ =BS .BOOK_SEQ  WHERE STATUS_CODE='B';
